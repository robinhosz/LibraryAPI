package com.robson.biblioteca.config;
...
import com.robson.biblioteca.serialization.converter.YamlJacsonToHttpMessageConverter;
...
//			.mediaType("xml", MediaType.APPLICATION_XML);
	...
	public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
		converters.add(new YamlJacsonToHttpMessageConverter());
	}
